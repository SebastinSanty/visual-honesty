...
ALTER FUNCTION "public"."add_stimulus"("p_set_name" "text", "p_image_url" "text", "p_is_deceptive" boolean, "p_name" "text", "p_category" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."create_ai_participant"("p_category" "text", "p_demographics" "jsonb") RETURNS "uuid"
...
ALTER FUNCTION "public"."create_ai_participant"("p_category" "text", "p_demographics" "jsonb") OWNER TO "postgres";
...
ALTER FUNCTION "public"."create_participant"("p_category" "text", "p_demographics" "jsonb") OWNER TO "postgres";
...
ALTER FUNCTION "public"."get_ai_results"("target_uuid" "uuid") OWNER TO "postgres";
...
ALTER FUNCTION "public"."get_binned_benchmarks"() OWNER TO "postgres";
...
ALTER FUNCTION "public"."get_participant_category_comparison"("target_uuid" "uuid") OWNER TO "postgres";
...
ALTER FUNCTION "public"."is_valid_participant"("p_session_id" "uuid") OWNER TO "postgres";
...
ALTER FUNCTION "public"."submit_response"("p_session_id" "uuid", "p_trial_id" "uuid", "p_choice" "uuid", "p_frontend_time" integer) OWNER TO "postgres";
...
ALTER FUNCTION "public"."upsert_ai_stats"("target_uuid" "uuid") OWNER TO "postgres";
...
ALTER FUNCTION "public"."upsert_participant_stats"("target_uuid" "uuid") OWNER TO "postgres";
...
ALTER TABLE "public"."ai_stats" OWNER TO "postgres";
...
ALTER VIEW "public"."ai_category_benchmarks" OWNER TO "postgres";
...
ALTER TABLE "public"."participant_stats" OWNER TO "postgres";
...
ALTER VIEW "public"."participant_category_benchmarks" OWNER TO "postgres";
...
GRANT ALL ON FUNCTION "public"."add_stimulus"("p_set_name" "text", "p_image_url" "text", "p_is_deceptive" boolean, "p_name" "text", "p_category" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."add_stimulus"("p_set_name" "text", "p_image_url" "text", "p_is_deceptive" boolean, "p_name" "text", "p_category" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."add_stimulus"("p_set_name" "text", "p_image_url" "text", "p_is_deceptive" boolean, "p_name" "text", "p_category" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."create_ai_participant"("p_category" "text", "p_demographics" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."create_ai_participant"("p_category" "text", "p_demographics" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_ai_participant"("p_category" "text", "p_demographics" "jsonb") TO "service_role";



GRANT ALL ON FUNCTION "public"."create_participant"("p_category" "text", "p_demographics" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."create_participant"("p_category" "text", "p_demographics" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_participant"("p_category" "text", "p_demographics" "jsonb") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_ai_results"("target_uuid" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_ai_results"("target_uuid" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_ai_results"("target_uuid" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."get_binned_benchmarks"() TO "anon";
GRANT ALL ON FUNCTION "public"."get_binned_benchmarks"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_binned_benchmarks"() TO "service_role";



GRANT ALL ON FUNCTION "public"."get_participant_category_comparison"("target_uuid" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_participant_category_comparison"("target_uuid" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_participant_category_comparison"("target_uuid" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."is_valid_participant"("p_session_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."is_valid_participant"("p_session_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."is_valid_participant"("p_session_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."submit_response"("p_session_id" "uuid", "p_trial_id" "uuid", "p_choice" "uuid", "p_frontend_time" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."submit_response"("p_session_id" "uuid", "p_trial_id" "uuid", "p_choice" "uuid", "p_frontend_time" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."submit_response"("p_session_id" "uuid", "p_trial_id" "uuid", "p_choice" "uuid", "p_frontend_time" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."upsert_ai_stats"("target_uuid" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."upsert_ai_stats"("target_uuid" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."upsert_ai_stats"("target_uuid" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."upsert_participant_stats"("target_uuid" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."upsert_participant_stats"("target_uuid" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."upsert_participant_stats"("target_uuid" "uuid") TO "service_role";
...
GRANT ALL ON TABLE "public"."ai_stats" TO "anon";
GRANT ALL ON TABLE "public"."ai_stats" TO "authenticated";
GRANT ALL ON TABLE "public"."ai_stats" TO "service_role";
...
GRANT ALL ON TABLE "public"."ai_category_benchmarks" TO "anon";
GRANT ALL ON TABLE "public"."ai_category_benchmarks" TO "authenticated";
GRANT ALL ON TABLE "public"."ai_category_benchmarks" TO "service_role";
...
GRANT ALL ON TABLE "public"."participant_stats" TO "anon";
GRANT ALL ON TABLE "public"."participant_stats" TO "authenticated";
GRANT ALL ON TABLE "public"."participant_stats" TO "service_role";



GRANT ALL ON TABLE "public"."participant_category_benchmarks" TO "anon";
GRANT ALL ON TABLE "public"."participant_category_benchmarks" TO "authenticated";
GRANT ALL ON TABLE "public"."participant_category_benchmarks" TO "service_role";
